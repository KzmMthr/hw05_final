...
def profile(request, username):
    ...
    #fwers_count = Follow.objects.filter(user=author).count()
    ...
    return render(
        ...
        {'page': page, 'paginator': paginator, 'post_count': post_count,
...
def post_view(request, username, post_id):
    ...
    return render(
        request, 'post.html',
        {'post': post, 'post_count': post_count, 'post_id': post_id, 'author': author, 'form': form, 'items': items}
        )
